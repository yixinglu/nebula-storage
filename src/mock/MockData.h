...
class MockData {
 public:
   ...
   * Mock schema
   */
  static std::shared_ptr<meta::NebulaSchemaProvider> mockPlayerTagSchema(SchemaVer ver = 0, bool hasProp = true);

  static std::shared_ptr<meta::NebulaSchemaProvider> mockTeamTagSchema(SchemaVer ver = 0, bool hasProp = true);

  static std::shared_ptr<meta::NebulaSchemaProvider> mockServeEdgeSchema(SchemaVer ver = 0, bool hasProp = true);

  static std::shared_ptr<meta::NebulaSchemaProvider> mockTeammateEdgeSchema(SchemaVer ver = 0, bool hasProp = true);
  ...
  static std::unordered_map<VertexID, std::vector<EdgeData>> mockmMultiRankServes(EdgeRanking rankCount = 1);
  ...
  static std::unordered_map<PartitionID, std::vector<VertexData>> mockVerticesofPart(int32_t parts = 6);
   ...
   * Mock request
   */
  static nebula::storage::cpp2::AddVerticesRequest mockAddVerticesReq(bool upper = false, int32_t parts = 6);

  static nebula::storage::cpp2::AddEdgesRequest mockAddEdgesReq(bool upper = false, int32_t parts = 6);
  ...
  static nebula::storage::cpp2::AddVerticesRequest mockAddVerticesSpecifiedOrderReq(int32_t parts = 6);
