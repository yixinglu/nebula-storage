...
folly::Future<cpp2::AdminExecResp> StorageAdminServiceHandler::future_transLeader(const cpp2::TransLeaderReq& req) {
  auto* processor = TransLeaderProcessor::instance(env_);
  RETURN_FUTURE(processor);
}

folly::Future<cpp2::AdminExecResp> StorageAdminServiceHandler::future_addPart(const cpp2::AddPartReq& req) {
  auto* processor = AddPartProcessor::instance(env_);
  RETURN_FUTURE(processor);
}

folly::Future<cpp2::AdminExecResp> StorageAdminServiceHandler::future_addLearner(const cpp2::AddLearnerReq& req) {
...
folly::Future<cpp2::AdminExecResp> StorageAdminServiceHandler::future_removePart(const cpp2::RemovePartReq& req) {
  auto* processor = RemovePartProcessor::instance(env_);
  RETURN_FUTURE(processor);
}

folly::Future<cpp2::AdminExecResp> StorageAdminServiceHandler::future_memberChange(const cpp2::MemberChangeReq& req) {
  auto* processor = MemberChangeProcessor::instance(env_);
  RETURN_FUTURE(processor);
}

folly::Future<cpp2::AdminExecResp> StorageAdminServiceHandler::future_checkPeers(const cpp2::CheckPeersReq& req) {
...
folly::Future<cpp2::AdminExecResp> StorageAdminServiceHandler::future_dropCheckpoint(const cpp2::DropCPRequest& req) {
