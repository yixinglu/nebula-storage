...
class SchemaWriter : public ResultSchemaProvider {
 public:
  ...
  SchemaWriter& appendCol(folly::StringPiece name, meta::cpp2::PropertyType type, int32_t fixedStrLen = 0,
                          bool nullable = false, Expression* defaultValue = nullptr) noexcept;
