...
void AdHocSchemaManager::addTagSchema(GraphSpaceID space, TagID tag,
...
void AdHocSchemaManager::addEdgeSchema(GraphSpaceID space, EdgeType edge,
                                       std::shared_ptr<nebula::meta::NebulaSchemaProvider> schema) {
  {
...
std::shared_ptr<const nebula::meta::NebulaSchemaProvider> AdHocSchemaManager::getTagSchema(GraphSpaceID space,
                                                                                           TagID tag, SchemaVer ver) {
...
std::shared_ptr<const nebula::meta::NebulaSchemaProvider> AdHocSchemaManager::getTagSchemaFromMap(GraphSpaceID space,
                                                                                                  TagID tag,
                                                                                                  SchemaVer ver) {
  folly::RWSpinLock::ReadHolder rh(tagLock_);
...
std::shared_ptr<const nebula::meta::NebulaSchemaProvider> AdHocSchemaManager::getEdgeSchema(GraphSpaceID space,
                                                                                            EdgeType edge,
                                                                                            SchemaVer ver) {
...
std::shared_ptr<const nebula::meta::NebulaSchemaProvider> AdHocSchemaManager::getEdgeSchemaFromMap(GraphSpaceID space,
                                                                                                   EdgeType edge,
                                                                                                   SchemaVer ver) {
  folly::RWSpinLock::ReadHolder rh(edgeLock_);
...
StatusOr<SchemaVer> AdHocSchemaManager::getLatestEdgeSchemaVersion(GraphSpaceID space, EdgeType edge) {
  folly::RWSpinLock::ReadHolder rh(edgeLock_);
  auto spaceIt = edgeSchemasInVector_.find(space);
  if (spaceIt == edgeSchemasInVector_.end()) {
    // Not found
...
StatusOr<TagSchema> AdHocSchemaManager::getAllLatestVerTagSchema(GraphSpaceID space) {
  ...
  std::unordered_map<TagID, std::shared_ptr<const meta::NebulaSchemaProvider>> tagsSchema;
...
StatusOr<std::vector<nebula::meta::cpp2::FTClient>> AdHocSchemaManager::getFTClients() { return ftClients_; }
