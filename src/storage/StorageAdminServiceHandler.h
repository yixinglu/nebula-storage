...
class StorageAdminServiceHandler final : public cpp2::StorageAdminServiceSvIf {
 public:
  ...
  folly::Future<cpp2::AdminExecResp> future_waitingForCatchUpData(const cpp2::CatchUpDataReq& req) override;
  ...
  folly::Future<cpp2::GetLeaderPartsResp> future_getLeaderParts(const cpp2::GetLeaderReq& req) override;

  folly::Future<cpp2::CreateCPResp> future_createCheckpoint(const cpp2::CreateCPRequest& req) override;

  folly::Future<cpp2::AdminExecResp> future_dropCheckpoint(const cpp2::DropCPRequest& req) override;

  folly::Future<cpp2::AdminExecResp> future_blockingWrites(const cpp2::BlockingSignRequest& req) override;

  folly::Future<cpp2::AdminExecResp> future_addAdminTask(const cpp2::AddAdminTaskRequest& req) override;

  folly::Future<cpp2::AdminExecResp> future_stopAdminTask(const cpp2::StopAdminTaskRequest& req) override;
