...
TEST(LogEncoderTest, BatchTest) {
  ...
  expectd.emplace_back(OP_BATCH_REMOVE, std::pair<folly::StringPiece, folly::StringPiece>("remove", ""));
  expectd.emplace_back(OP_BATCH_PUT, std::pair<folly::StringPiece, folly::StringPiece>("put_key", "put_value"));
  expectd.emplace_back(OP_BATCH_REMOVE_RANGE, std::pair<folly::StringPiece, folly::StringPiece>("begin", "end"));
