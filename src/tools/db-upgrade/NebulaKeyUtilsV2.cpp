...
// static
std::string NebulaKeyUtilsV2::vertexKey(size_t vIdLen, PartitionID partId, VertexID vId, TagID tagId, TagVersion tv) {
...
// static
std::string NebulaKeyUtilsV2::edgeKey(size_t vIdLen, PartitionID partId, VertexID srcId, EdgeType type,
                                      EdgeRanking rank, VertexID dstId, EdgeVersion ev) {
...
// static
std::string NebulaKeyUtilsV2::vertexPrefix(size_t vIdLen, PartitionID partId, VertexID vId, TagID tagId) {
  CHECK_GE(vIdLen, vId.size());
  tagId &= kTagMaskSet;
...
// static
std::string NebulaKeyUtilsV2::edgePrefix(size_t vIdLen, PartitionID partId, VertexID srcId, EdgeType type) {
  CHECK_GE(vIdLen, srcId.size());
  type |= kEdgeMaskSet;
  PartitionID item = (partId << kPartitionOffset) | static_cast<uint32_t>(NebulaKeyTypeV2::kData);
