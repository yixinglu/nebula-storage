...
std::pair<ResultCode, std::vector<Status>> HBaseClient::multiGet(const std::string& tableName,
...
ResultCode HBaseClient::put(const std::string& tableName, std::string& rowKey, std::vector<KV>& data) {
  TPut tPut;
  tPut.set_row(rowKey);
...
ResultCode HBaseClient::range(const std::string& tableName, const std::string& startRowKey,
                              const std::string& endRowKey, std::vector<std::pair<std::string, KVMap>>& dataList) {
...
ResultCode HBaseClient::multiRemove(const std::string& tableName, std::vector<std::string>& rowKeys) {
