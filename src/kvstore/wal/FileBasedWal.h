...
class FileBasedWal final : public Wal, public std::enable_shared_from_this<FileBasedWal> {
 ...
 public:
  ...
  static std::shared_ptr<FileBasedWal> getWal(const folly::StringPiece dir, const std::string& idStr,
 ...
 private:
  ...
  FileBasedWal(const folly::StringPiece dir, const std::string& idStr, FileBasedWalPolicy policy,
