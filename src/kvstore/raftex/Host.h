...
class Host final : public std::enable_shared_from_this<Host> {
 ...
 public:
  ...
  folly::Future<cpp2::AskForVoteResponse> askForVote(const cpp2::AskForVoteRequest& req, folly::EventBase* eb);
 ...
 private:
  ...
  folly::Future<cpp2::AppendLogResponse> sendAppendLogRequest(folly::EventBase* eb,
