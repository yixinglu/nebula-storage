...
typename std::enable_if<
    std::is_integral<typename std::remove_cv<typename std::remove_reference<IntType>::type>::type>::value, bool>::type
intToBool(IntType iVal) {
  return iVal != 0;
}

inline bool strToBool(folly::StringPiece str) {
  return str == "Y" || str == "y" || str == "T" || str == "t" || str == "yes" || str == "Yes" || str == "YES" ||
