...
class MetaServiceHandler final : public cpp2::MetaServiceSvIf {
 public:
  explicit MetaServiceHandler(kvstore::KVStore* kv, ClusterID clusterId = 0) : kvstore_(kv), clusterId_(clusterId) {
  ...
  folly::Future<cpp2::GetPartsAllocResp> future_getPartsAlloc(const cpp2::GetPartsAllocReq& req) override;
  ...
  folly::Future<cpp2::ListTagIndexesResp> future_listTagIndexes(const cpp2::ListTagIndexesReq& req) override;

  folly::Future<cpp2::ExecResp> future_createEdgeIndex(const cpp2::CreateEdgeIndexReq& req) override;

  folly::Future<cpp2::ExecResp> future_dropEdgeIndex(const cpp2::DropEdgeIndexReq& req) override;

  folly::Future<cpp2::GetEdgeIndexResp> future_getEdgeIndex(const cpp2::GetEdgeIndexReq& req) override;

  folly::Future<cpp2::ListEdgeIndexesResp> future_listEdgeIndexes(const cpp2::ListEdgeIndexesReq& req) override;

  folly::Future<cpp2::ListIndexStatusResp> future_listTagIndexStatus(const cpp2::ListIndexStatusReq& req) override;

  folly::Future<cpp2::ListIndexStatusResp> future_listEdgeIndexStatus(const cpp2::ListIndexStatusReq& req) override;

  folly::Future<cpp2::ExecResp> future_signInFTService(const cpp2::SignInFTServiceReq& req) override;

  folly::Future<cpp2::ExecResp> future_signOutFTService(const cpp2::SignOutFTServiceReq& req) override;

  folly::Future<cpp2::ListFTClientsResp> future_listFTClients(const cpp2::ListFTClientsReq& req) override;
  ...
  folly::Future<cpp2::ListSnapshotsResp> future_listSnapshots(const cpp2::ListSnapshotsReq& req) override;

  folly::Future<cpp2::AdminJobResp> future_runAdminJob(const cpp2::AdminJobReq& req) override;

  folly::Future<cpp2::CreateBackupResp> future_createBackup(const cpp2::CreateBackupReq& req) override;
  /**
   * Zone manager
   **/
  ...
  folly::Future<cpp2::ExecResp> future_addHostIntoZone(const cpp2::AddHostIntoZoneReq& req) override;

  folly::Future<cpp2::ExecResp> future_dropHostFromZone(const cpp2::DropHostFromZoneReq& req) override;
  ...
  folly::Future<cpp2::ExecResp> future_addZoneIntoGroup(const cpp2::AddZoneIntoGroupReq& req) override;

  folly::Future<cpp2::ExecResp> future_dropZoneFromGroup(const cpp2::DropZoneFromGroupReq& req) override;
  ...
  folly::Future<cpp2::ListListenerResp> future_listListener(const cpp2::ListListenerReq& req) override;
