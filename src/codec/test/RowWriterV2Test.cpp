...
TEST(RowWriterV2, NumericLimit) {
  ...
  {
    RowWriterV2 writer(&schema);
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(0, static_cast<int8_t>(std::numeric_limits<int8_t>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(0, static_cast<int16_t>(std::numeric_limits<int8_t>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(0, static_cast<int32_t>(std::numeric_limits<int8_t>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(0, static_cast<int64_t>(std::numeric_limits<int8_t>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(0, static_cast<float>(std::numeric_limits<int8_t>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(0, static_cast<double>(std::numeric_limits<int8_t>::min())));

    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(0, static_cast<int8_t>(std::numeric_limits<int8_t>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(0, static_cast<int16_t>(std::numeric_limits<int8_t>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(0, static_cast<int32_t>(std::numeric_limits<int8_t>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(0, static_cast<int64_t>(std::numeric_limits<int8_t>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(0, static_cast<float>(std::numeric_limits<int8_t>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(0, static_cast<double>(std::numeric_limits<int8_t>::max())));

    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(1, static_cast<int16_t>(std::numeric_limits<int16_t>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(1, static_cast<int32_t>(std::numeric_limits<int16_t>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(1, static_cast<int64_t>(std::numeric_limits<int16_t>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(1, static_cast<float>(std::numeric_limits<int16_t>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(1, static_cast<double>(std::numeric_limits<int16_t>::min())));

    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(1, static_cast<int16_t>(std::numeric_limits<int16_t>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(1, static_cast<int32_t>(std::numeric_limits<int16_t>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(1, static_cast<int64_t>(std::numeric_limits<int16_t>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(1, static_cast<float>(std::numeric_limits<int16_t>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(1, static_cast<double>(std::numeric_limits<int16_t>::max())));

    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(2, static_cast<int32_t>(std::numeric_limits<int32_t>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(2, static_cast<int64_t>(std::numeric_limits<int32_t>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(2, static_cast<float>(std::numeric_limits<int32_t>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(2, static_cast<double>(std::numeric_limits<int32_t>::min())));

    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(2, static_cast<int32_t>(std::numeric_limits<int32_t>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(2, static_cast<int64_t>(std::numeric_limits<int32_t>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(2, static_cast<float>(std::numeric_limits<int32_t>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(2, static_cast<double>(std::numeric_limits<int32_t>::max())));

    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(3, static_cast<int64_t>(std::numeric_limits<int64_t>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(3, static_cast<double>(std::numeric_limits<int64_t>::min())));

    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(3, static_cast<int64_t>(std::numeric_limits<int64_t>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(3, static_cast<double>(std::numeric_limits<int64_t>::max())));

    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(4, static_cast<int32_t>(std::numeric_limits<float>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(4, static_cast<int64_t>(std::numeric_limits<float>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(4, static_cast<float>(std::numeric_limits<float>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(4, static_cast<double>(std::numeric_limits<float>::min())));

    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(4, static_cast<int32_t>(std::numeric_limits<float>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(4, static_cast<int64_t>(std::numeric_limits<float>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(4, static_cast<float>(std::numeric_limits<float>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(4, static_cast<double>(std::numeric_limits<float>::max())));

    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(5, static_cast<int64_t>(std::numeric_limits<double>::min())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(5, static_cast<double>(std::numeric_limits<double>::min())));

    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(5, static_cast<int64_t>(std::numeric_limits<double>::max())));
    EXPECT_EQ(WriteResult::SUCCEEDED, writer.set(5, static_cast<double>(std::numeric_limits<double>::max())));
  }
  {
    RowWriterV2 writer(&schema);
...
TEST(RowWriterV2, TimestampTest) {
  {
    ...
    EXPECT_EQ("", v1.getStr());
    EXPECT_EQ("", v2.getStr());
    auto ret = (reader->getTimestamp() >= ts) && (reader->getTimestamp() <= time::WallClock::fastNowInMicroSec());
    EXPECT_TRUE(ret);
  }
  {
    SchemaWriter schema(1);
