...
class AddZoneIntoGroupProcessor : public BaseProcessor<cpp2::ExecResp> {
 ...
 private:
  explicit AddZoneIntoGroupProcessor(kvstore::KVStore* kvstore) : BaseProcessor<cpp2::ExecResp>(kvstore) {}
};
...
class DropZoneFromGroupProcessor : public BaseProcessor<cpp2::ExecResp> {
 ...
 private:
  explicit DropZoneFromGroupProcessor(kvstore::KVStore* kvstore) : BaseProcessor<cpp2::ExecResp>(kvstore) {}
};
