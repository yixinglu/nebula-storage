...
class BaseProcessor {
 ...
 protected:
   ...
   * */
  StatusOr<std::vector<std::string>> doScan(const std::string& start, const std::string& end);
  /**
   ...
   */
  StatusOr<cpp2::Schema> getLatestTagSchema(GraphSpaceID spaceId, const TagID tagId);
   ...
   */
  StatusOr<cpp2::Schema> getLatestEdgeSchema(GraphSpaceID spaceId, const EdgeType edgeType);
  ...
  StatusOr<std::vector<cpp2::IndexItem>> getIndexes(GraphSpaceID spaceId, int32_t tagOrEdge);
