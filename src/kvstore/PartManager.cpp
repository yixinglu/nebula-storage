...
StatusOr<std::vector<meta::RemoteListenerInfo>> MemPartManager::listenerPeerExist(GraphSpaceID spaceId,
                                                                                  PartitionID partId) {
...
StatusOr<meta::PartHosts> MemPartManager::partMeta(GraphSpaceID spaceId, PartitionID partId) {
  ...
  if (partIt == it->second.end()) {
    return Status::Error("Part not found in MemPartManager, spaceid: %d, partId: %d ", spaceId, partId);
  }
...
Status MetaServerBasedPartManager::partExist(const HostAddr& host, GraphSpaceID spaceId, PartitionID partId) {
...
void MetaServerBasedPartManager::onSpaceOptionUpdated(GraphSpaceID spaceId,
...
void MetaServerBasedPartManager::onPartUpdated(const meta::PartHosts& partMeta) { UNUSED(partMeta); }
...
StatusOr<std::vector<meta::RemoteListenerInfo>> MetaServerBasedPartManager::listenerPeerExist(GraphSpaceID spaceId,
                                                                                              PartitionID partId) {
  return client_->getListenerHostTypeBySpacePartType(spaceId, partId);
}

void MetaServerBasedPartManager::onListenerAdded(GraphSpaceID spaceId, PartitionID partId,
...
void MetaServerBasedPartManager::onListenerRemoved(GraphSpaceID spaceId, PartitionID partId,
...
void MetaServerBasedPartManager::onCheckRemoteListeners(GraphSpaceID spaceId, PartitionID partId,
