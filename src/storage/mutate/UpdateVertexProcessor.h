...
class UpdateVertexProcessor : public QueryBaseProcessor<cpp2::UpdateVertexRequest, cpp2::UpdateResponse> {
 public:
  static UpdateVertexProcessor* instance(StorageEnv* env, const ProcessorCounters* counters = &kUpdateVertexCounters,
 ...
 private:
  UpdateVertexProcessor(StorageEnv* env, const ProcessorCounters* counters, folly::Executor* executor,
                        VertexCache* cache)
      : QueryBaseProcessor<cpp2::UpdateVertexRequest, cpp2::UpdateResponse>(env, counters, executor, cache) {}
