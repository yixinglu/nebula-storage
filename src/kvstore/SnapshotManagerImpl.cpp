...
void SnapshotManagerImpl::accessAllRowsInSnapshot(GraphSpaceID spaceId, PartitionID partId,
...
bool SnapshotManagerImpl::accessTable(GraphSpaceID spaceId, PartitionID partId, const std::string& prefix,
                                      raftex::SnapshotCallback& cb, std::vector<std::string>& data, int64_t& totalCount,
                                      int64_t& totalSize) {
