...
std::string encodeBatchValue(const std::vector<std::tuple<BatchLogType, std::string, std::string>>& batch);

std::vector<std::pair<BatchLogType, std::pair<folly::StringPiece, folly::StringPiece>>> decodeBatchValue(
    folly::StringPiece encoded);
...
class BatchHolder {
 public:
  ...
  void put(std::string&& key, std::string&& val) {
    auto op =
        std::make_tuple(BatchLogType::OP_BATCH_PUT, std::forward<std::string>(key), std::forward<std::string>(val));
  ...
  void rangeRemove(std::string&& begin, std::string&& end) {
    auto op = std::make_tuple(BatchLogType::OP_BATCH_REMOVE_RANGE, std::forward<std::string>(begin),
  ...
  const std::vector<std::tuple<BatchLogType, std::string, std::string>>& getBatch() { return batch_; }
