...
keeps poping out edge data. All tage data has been put into ExpressionContext
...
class FilterNode : public IterateNode<T> {
 public:
  ...
  FilterNode(PlanContext* planCtx, IterateNode<T>* upstream, StorageExpressionContext* expCtx = nullptr,
             Expression* exp = nullptr)
      : IterateNode<T>(upstream), planContext_(planCtx), expCtx_(expCtx), filterExp_(exp) {}
