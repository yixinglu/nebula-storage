...
RowWriterV1& RowWriterV1::operator<<(const std::string& v) noexcept { return operator<<(folly::StringPiece(v)); }

RowWriterV1& RowWriterV1::operator<<(const char* v) noexcept { return operator<<(folly::StringPiece(v)); }
