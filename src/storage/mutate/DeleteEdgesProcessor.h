...
class DeleteEdgesProcessor : public BaseProcessor<cpp2::ExecResponse> {
 public:
  static DeleteEdgesProcessor* instance(StorageEnv* env, const ProcessorCounters* counters = &kDelEdgesCounters) {
 ...
 private:
  ...
  ErrorOr<kvstore::ResultCode, std::string> deleteEdges(PartitionID partId, const std::vector<cpp2::EdgeKey>& edges);
