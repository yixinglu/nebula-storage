...
TEST(LookupIndexTest, LookupIndexTestV1) {
  ...
  // setup v1 data and v2 data
  {
    ...
    env->kvstore_->asyncMultiPut(spaceId, 1, std::move(keyValues), [&](kvstore::ResultCode code) {
   ...
   **/
  {
    ...
    std::vector<std::string> expectCols = {std::string("1.").append(kVid), "1.col_bool", "1.col_int"};
...
TEST(LookupIndexTest, SimpleTagIndexTest) {
   ...
   **/
  {
    ...
    processor->process(req);
    auto resp = std::move(fut).get();
    std::vector<std::string> expectCols = {std::string("1.").append(kVid), std::string("1.").append(kTag), "1.age"};
    decltype(resp.get_data()->rows) expectRows;
...
TEST(LookupIndexTest, SimpleEdgeIndexTest) {
   ...
   **/
  {
    ...
    processor->process(req);
    auto resp = std::move(fut).get();
    std::vector<std::string> expectCols = {std::string("102.").append(kSrc), std::string("102.").append(kType),
                                           std::string("102.").append(kRank), std::string("102.").append(kDst),
                                           "102.teamName"};
    decltype(resp.get_data()->rows) expectRows;
...
TEST(LookupIndexTest, TagIndexFilterTest) {
   ...
   **/
  {
    ...
    RelationalExpression expr(
        ...
        new TagPropertyExpression(new std::string(folly::to<std::string>("player")), new std::string("age")),
...
TEST(LookupIndexTest, EdgeIndexFilterTest) {
   ...
   **/
  {
    ...
    RelationalExpression expr(
        Expression::Kind::kRelGT,
        new EdgePropertyExpression(new std::string(folly::to<std::string>("Teammate")), new std::string("teamName")),
...
TEST(LookupIndexTest, TagIndexWithDataTest) {
   ...
   **/
  {
    ...
    processor->process(req);
    auto resp = std::move(fut).get();
    std::vector<std::string> expectCols = {std::string("1.").append(kVid), std::string("1.").append(kTag), "1.games"};
    decltype(resp.get_data()->rows) expectRows;
...
TEST(LookupIndexTest, TagWithPropStatisVerticesIndexTest) {
   ...
   **/
  {
    ...
    processor->process(req);
    auto resp = std::move(fut).get();
    std::vector<std::string> expectCols = {std::string("1.").append(kVid), std::string("1.").append(kTag)};
    decltype(resp.get_data()->rows) expectRows;
...
TEST(LookupIndexTest, EdgeWithPropStatisVerticesIndexTest) {
   ...
   **/
  {
    ...
    processor->process(req);
    auto resp = std::move(fut).get();
    std::vector<std::string> expectCols = {std::string("101.").append(kSrc), std::string("101.").append(kType),
...
TEST(LookupIndexTest, NullableInIndexAndFilterTest) {
  ...
  auto genVid = [vIdLen](std::string& vId) -> std::string { return vId.append(vIdLen - sizeof(vId), '\0'); };
  ...
  }
  {
    ...
    RelationalExpression expr(Expression::Kind::kRelGT,
                              new TagPropertyExpression(new std::string("111"), new std::string("col3")),
  ...
  }
  {
    ...
    nebula::LogicalExpression expr(
        ...
        new RelationalExpression(Expression::Kind::kRelGT,
                                 ...
                                 new ConstantExpression(Value(1))),
        new RelationalExpression(Expression::Kind::kRelGT,
                                 new TagPropertyExpression(new std::string("111"), new std::string("col4")),
...
TEST(LookupIndexTest, NullablePropertyTest) {
  ...
  auto columnHint = [](const std::string& col, const cpp2::ScanType& scanType, const Value& begin, const Value& end) {
  ...
  }
  {
    ...
    columnHints.emplace_back(
        columnHint("col_int", cpp2::ScanType::RANGE, Value(3), Value(std::numeric_limits<int64_t>::max())));
  ...
  }
  {
    ...
    columnHints.emplace_back(columnHint("col_bool", cpp2::ScanType::PREFIX, Value(true), Value()));
    columnHints.emplace_back(
        columnHint("col_int", cpp2::ScanType::RANGE, Value(std::numeric_limits<int64_t>::min()), Value(4)));
  ...
  }
  {
    ...
    columnHints.emplace_back(columnHint("col_int", cpp2::ScanType::PREFIX, Value(1), Value()));
    columnHints.emplace_back(
        columnHint("col_double", cpp2::ScanType::RANGE, Value(-std::numeric_limits<double>::max()), Value(2.0)));
  ...
  }
  {
    ...
    columnHints.emplace_back(columnHint("col_double", cpp2::ScanType::RANGE, Value(0.0 + kEpsilon),
  ...
  }
  {
    ...
    columnHints.emplace_back(columnHint("col_bool", cpp2::ScanType::PREFIX, Value(false), Value()));
    columnHints.emplace_back(columnHint("col_int", cpp2::ScanType::PREFIX, Value(5), Value()));
    columnHints.emplace_back(columnHint("col_double", cpp2::ScanType::RANGE, Value(0.0), Value(10.0)));
  ...
  }
  {
    ...
    columnHints.emplace_back(columnHint("col_str", cpp2::ScanType::RANGE, Value(begin), Value(end)));
  ...
  }
  {
    ...
    std::vector<cpp2::IndexColumnHint> columnHints;
    columnHints.emplace_back(columnHint("col_bool", cpp2::ScanType::PREFIX, Value(NullType::__NULL__), Value()));
  ...
  }
  {
    ...
    std::vector<cpp2::IndexColumnHint> columnHints;
    columnHints.emplace_back(columnHint("col_bool", cpp2::ScanType::PREFIX, Value(NullType::__NULL__), Value()));
    columnHints.emplace_back(columnHint("col_int", cpp2::ScanType::PREFIX, Value(NullType::__NULL__), Value()));
  ...
  }
  {
    ...
    columnHints.emplace_back(columnHint("col_bool", cpp2::ScanType::PREFIX, Value(NullType::__NULL__), Value()));
    columnHints.emplace_back(columnHint("col_int", cpp2::ScanType::PREFIX, Value(NullType::__NULL__), Value()));
    columnHints.emplace_back(columnHint("col_double", cpp2::ScanType::PREFIX, Value(NullType::__NULL__), Value()));
  ...
  }
  {
    ...
    columnHints.emplace_back(columnHint("col_int", cpp2::ScanType::PREFIX, Value(NullType::__NULL__), Value()));
    columnHints.emplace_back(columnHint("col_double", cpp2::ScanType::PREFIX, Value(NullType::__NULL__), Value()));
    columnHints.emplace_back(columnHint("col_str", cpp2::ScanType::PREFIX, Value(NullType::__NULL__), Value()));
  ...
  }
  {
    ...
    columnHints.emplace_back(
        columnHint("col_str", cpp2::ScanType::RANGE, Value(std::string(strColLen, '\0')), Value("d")));
  ...
  }
  {
    ...
    columnHints.emplace_back(columnHint("col_int", cpp2::ScanType::PREFIX, Value(NullType::__NULL__), Value()));
    columnHints.emplace_back(
        columnHint("col_double", cpp2::ScanType::RANGE, Value(0.0), Value(std::numeric_limits<double>::max())));
