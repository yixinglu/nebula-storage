...
Value StorageExpressionContext::getTagProp(const std::string& tagName, const std::string& prop) const {
  if (isIndex_) {
...
Value StorageExpressionContext::getEdgeProp(const std::string& edgeName, const std::string& prop) const {
  if (isIndex_) {
...
Value StorageExpressionContext::getSrcProp(const std::string& tagName, const std::string& prop) const {
  if (!isEdge_ && reader_ != nullptr) {
    if (tagName != name_) {
      return Value::kNullValue;
    }
