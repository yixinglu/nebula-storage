...
// static
std::string IndexKeyUtils::vertexIndexKey(size_t vIdLen, PartitionID partId, IndexID indexId, const VertexID& vId,
                                          std::string&& values) {
...
// static
std::string IndexKeyUtils::edgeIndexKey(size_t vIdLen, PartitionID partId, IndexID indexId, const VertexID& srcId,
...
// static
StatusOr<std::string> IndexKeyUtils::collectIndexValues(RowReader* reader,
                                                        const std::vector<nebula::meta::cpp2::ColumnDef>& cols) {
  if (reader == nullptr) {
