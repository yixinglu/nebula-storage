...
TEST(GetNeighborsTest, PropertyTest) {
  ...
  }
  {
    ...
    edges.emplace_back(serve, std::vector<std::string>{"teamName", "startYear", "endYear", kSrc, kType, kRank, kDst});
    auto req = QueryTestUtils::buildRequest(totalParts, vertices, over, tags, edges);
  ...
  }
  {
    ...
    edges.emplace_back(-serve,
                       std::vector<std::string>{"playerName", "startYear", "teamCareer", kSrc, kType, kRank, kDst});
    auto req = QueryTestUtils::buildRequest(totalParts, vertices, over, tags, edges);
  ...
  }
  {
    ...
    tags.emplace_back(player,
                      std::vector<std::string>{"name", "age", "playing", "career", "startYear", "endYear", "games",
                                               "avgScore", "serveTeams", "country", "champions", kVid, kTag});
    edges.emplace_back(
        serve, std::vector<std::string>{"teamName", "startYear", "endYear", "playerName", "teamCareer", "teamGames",
                                        "teamAvgScore", "type", "champions", kSrc, kType, kRank, kDst});
    auto req = QueryTestUtils::buildRequest(totalParts, vertices, over, tags, edges);
...
TEST(GetNeighborsTest, GoFromMultiVerticesTest) {
  ...
  }
  {
    ...
    std::vector<std::pair<TagID, std::vector<std::string>>> tags;
    std::vector<std::pair<EdgeType, std::vector<std::string>>> edges;
    tags.emplace_back(player, std::vector<std::string>{"name", "age", "playing", "career", "startYear", "endYear",
                                                       "games", "avgScore", "serveTeams", "country", "champions"});
    edges.emplace_back(serve, std::vector<std::string>{"teamName", "startYear", "endYear", "teamCareer", "teamGames",
                                                       "teamAvgScore", "type", "champions", kSrc, kType, kRank, kDst});
    edges.emplace_back(teammate, std::vector<std::string>{"player1", "player2", "teamName", "startYear", "endYear"});
    auto req = QueryTestUtils::buildRequest(totalParts, vertices, over, tags, edges);
...
TEST(GetNeighborsTest, StatTest) {
...

  {
    ...
    std::vector<cpp2::StatProp> statProps;
    {
      ...
      EdgePropertyExpression exp(new std::string(folly::to<std::string>(serve)), new std::string("teamGames"));
    ...
    }
    {
      ...
      EdgePropertyExpression exp(new std::string(folly::to<std::string>(serve)), new std::string("teamAvgScore"));
      statProp.set_prop(Expression::encode(exp));
    ...
    }
    {
      ...
      EdgePropertyExpression exp(new std::string(folly::to<std::string>(serve)), new std::string("teamCareer"));
      statProp.set_prop(Expression::encode(exp));
    ...
    expectStat.emplace("LeBron James", std::vector<Value>{548 + 294 + 301 + 115, (29.7 + 27.1 + 27.5 + 25.7) / 4, 7,
                                                          2003 + 2010 + 2014 + 2018});

    ASSERT_EQ(0, (*resp.result_ref()).failed_parts.size());
    // vId, stat, player, serve, expr
    QueryTestUtils::checkResponse(*resp.vertices_ref(), vertices, over, tags, edges, 1, 5, &expectStat);
  }
  {
    ...
    std::unordered_map<VertexID, std::vector<Value>> expectStat;
    expectStat.emplace("LeBron James", std::vector<Value>{(29.7 + 27.1 + 27.5 + 25.7) / 4, 25.7, 29.7});
...
TEST(GetNeighborsTest, FailedTest) {
  ...
  }
  {
    ...
    ASSERT_EQ(1, (*resp.result_ref()).failed_parts.size());
    ASSERT_EQ(cpp2::ErrorCode::E_EDGE_NOT_FOUND, (*resp.result_ref()).failed_parts.front().code);
  }
  {
    ...
    ASSERT_EQ(1, (*resp.result_ref()).failed_parts.size());
    ASSERT_EQ(cpp2::ErrorCode::E_TAG_PROP_NOT_FOUND, (*resp.result_ref()).failed_parts.front().code);
  }
  {
    ...
    ASSERT_EQ(1, (*resp.result_ref()).failed_parts.size());
    ASSERT_EQ(cpp2::ErrorCode::E_EDGE_PROP_NOT_FOUND, (*resp.result_ref()).failed_parts.front().code);
  }
}
...
TEST(GetNeighborsTest, FilterTest) {
...

  {
...

    {
      ...
      RelationalExpression exp(
          ...
          new EdgePropertyExpression(new std::string(folly::to<std::string>(serve)), new std::string("teamAvgScore")),
    ...
    expected.colNames = {kVid, "_stats", "_tag:1:name:age:avgScore", "_edge:+101:teamName:startYear:endYear", "_expr"};
    nebula::Row row({"Tracy McGrady", Value(), nebula::List({"Tracy McGrady", 41, 19.6}),
  ...
  }
  {
...

    {
      ...
      RelationalExpression exp(
          ...
          new ArithmeticExpression(
              ...
              new EdgePropertyExpression(new std::string(folly::to<std::string>(serve)), new std::string("endYear")),
              new EdgePropertyExpression(new std::string(folly::to<std::string>(serve)), new std::string("startYear"))),
    ...
    nebula::Row row({"Tracy McGrady", Value(), nebula::List({"Tracy McGrady", 41, 19.6}), serveEdges, Value()});
    expected.rows.emplace_back(std::move(row));
    ASSERT_EQ(expected, *resp.vertices_ref());
  }
  {
...

    {
      ...
      LogicalExpression exp(
          ...
          new RelationalExpression(
              ...
              new EdgePropertyExpression(new std::string(folly::to<std::string>(serve)), new std::string("teamCareer")),
  ...
  }
  {
...

    {
      ...
      LogicalExpression exp(
          ...
          new RelationalExpression(
              Expression::Kind::kRelLE,
              new SourcePropertyExpression(new std::string(folly::to<std::string>(player)), new std::string("games")),
  ...
  }
  {
    ...
    std::vector<VertexID> vertices = {"Tracy McGrady", "Tim Duncan", "Tony Parker", "Manu Ginobili"};
    std::vector<EdgeType> over = {serve};
    std::vector<std::pair<TagID, std::vector<std::string>>> tags;
    std::vector<std::pair<EdgeType, std::vector<std::string>>> edges;
    tags.emplace_back(player, std::vector<std::string>{"name", "age", "avgScore"});
    ...
    }
    {
      ...
      nebula::Row row({"Tim Duncan", Value(), nebula::List({"Tim Duncan", 44, 19.0}), serveEdges, Value()});
      for (size_t i = 0; i < 4; i++) {
    ...
    }
    {
      ...
      nebula::Row row({"Tony Parker", Value(), nebula::List({"Tony Parker", 38, 15.5}), Value(), Value()});
      for (size_t i = 0; i < 4; i++) {
    ...
    }
    {
      // same as 1.0, tag data is returned even if can't pass the filter.
      // no edge satisfies the filter
      nebula::Row row({"Manu Ginobili", Value(), nebula::List({"Manu Ginobili", 42, 13.3}), Value(), Value()});
      for (size_t i = 0; i < 4; i++) {
  ...
  }
  {
...

    {
      ...
      RelationalExpression exp(
          Expression::Kind::kRelGT,
          new EdgePropertyExpression(new std::string(folly::to<std::string>(serve)), new std::string("teamGames")),
          new ConstantExpression(Value(1000)));
      (*req.traverse_spec_ref()).set_filter(Expression::encode(exp));
    }
    ...
    nebula::Row row({"Tim Duncan", Value(), nebula::List({"Tim Duncan", 44, 19.0}), serveEdges, Value(), Value()});
    expected.rows.emplace_back(std::move(row));
    ASSERT_EQ(expected, *resp.vertices_ref());
  }
  {
    ...
    std::vector<std::pair<EdgeType, std::vector<std::string>>> edges;
    tags.emplace_back(team, std::vector<std::string>{"name"});
    edges.emplace_back(-serve, std::vector<std::string>{"teamName", "startYear", "endYear", kSrc, kDst});
    auto req = QueryTestUtils::buildRequest(totalParts, vertices, over, tags, edges);
    ...
    // vId, stat, player, serve, expr
    nebula::DataSet expected;
    expected.colNames = {kVid, "_stats", "_tag:2:name",
                         folly::stringPrintf("_edge:-101:teamName:startYear:endYear:%s:%s", kSrc, kDst), "_expr"};
    nebula::Row row({"Spurs", Value(), nebula::List({"Spurs"}),
  ...
  }
  {
    ...
    std::vector<std::pair<EdgeType, std::vector<std::string>>> edges;
    tags.emplace_back(player, std::vector<std::string>{"name", "age", "avgScore"});
    edges.emplace_back(teammate, std::vector<std::string>{kSrc, kType, kDst, "teamName", "startYear", "endYear"});
    edges.emplace_back(-teammate, std::vector<std::string>{kSrc, kType, kDst, "teamName", "startYear", "endYear"});
    auto req = QueryTestUtils::buildRequest(totalParts, vertices, over, tags, edges);

    {
      ...
      RelationalExpression exp(
          ...
          new EdgePropertyExpression(new std::string(folly::to<std::string>(teammate)), new std::string("startYear")),
    ...
    expected.colNames = {kVid,
                         ...
                         folly::stringPrintf("_edge:-102:%s:%s:%s:teamName:startYear:endYear", kSrc, kType, kDst),
                         "_expr"};
    nebula::Row row({"Tim Duncan", Value(), nebula::List({"Tim Duncan", 44, 19.0}),
                     nebula::List(nebula::List({"Tim Duncan", 102, "Tony Parker", "Spurs", 2001, 2016})),
                     nebula::List(nebula::List({"Tim Duncan", -102, "Tony Parker", "Spurs", 2001, 2016})), Value(),
                     Value()});
  }
}
